...
def test_calculate_age_in_minutes():
    assert seasons.calculate_age_in_minutes(date(2000, 1, 1), date(2020, 1, 1)) == 10519200
    assert seasons.calculate_age_in_minutes(date(1990, 6, 15), date(2024, 6, 15)) == 17883360
...
def test_output_format():
    ...
    assert output == "Ten million, five hundred nineteen thousand, two hundred minutes"
